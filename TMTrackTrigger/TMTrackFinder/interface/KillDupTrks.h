...
private:
  ...
  */
  std::vector<T> filterAlg1(const std::vector<T>& vecTracks) const;
  ...
  */
  std::vector<T> filterAlg2(const std::vector<T>& vecTracks) const;
  ...
  */
  std::vector<T> filterAlg3(const std::vector<T>& vecTracks) const;
  ...
  */
  std::vector<T> filterAlg4(const std::vector<T>& vecTracks) const;
  ...
  */
  std::vector<T> filterAlg5(const std::vector<T>& vecTracks) const;
  ...
  */
  std::vector<T> filterAlg6(const std::vector<T>& vecTracks) const;
  ...
  */
  std::vector<T> filterAlg7(const std::vector<T>& vecTracks) const;
  ...
  */
   ...
   */
  std::vector<T> filterAlg18(const std::vector<T>& vecTracks) const;
 ...
 /**
   ...
   */
  std::vector<T> filterAlg19(const std::vector<T>& vecTracks) const;
  ...
  */
  std::vector<T> filterAlg100(const std::vector<T>& vecTracks) const;
