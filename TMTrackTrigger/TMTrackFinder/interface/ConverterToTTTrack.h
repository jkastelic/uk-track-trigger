...
public:
  ...
  TTTrack< Ref_PixelDigi_ > makeTTTrack(const L1track3D&        trk     , unsigned int iPhiSec, unsigned int iEtaReg) const;
  // Convert L1fittedTrack (track candidate after fit) to TTTrack format.
  TTTrack< Ref_PixelDigi_ > makeTTTrack(const L1fittedTrack&    trk     , unsigned int iPhiSec, unsigned int iEtaReg) const;
  // Convert L1fittedTrk4and5 (track candidate after fit) to TTTrack format.
  TTTrack< Ref_PixelDigi_ > makeTTTrack(const L1fittedTrk4and5& trk4and5, unsigned int iPhiSec, unsigned int iEtaReg) const;
