...
public:
  ...
  L1track2D(const Settings* settings,
	  ...
	  std::pair<unsigned int, unsigned int> cellLocation,
  ...
  std::pair<unsigned int, unsigned int> getCellLocation()       const  {return cellLocation_;}
  ...
  std::pair<unsigned int, unsigned int>  getCellLocationRphi() const {if (! isRphi_) throw cms::Exception("L1track2D ERROR: You asked for r-phi HT cell of r-z track."); return cellLocation_;}
  std::pair<unsigned int, unsigned int>  getCellLocationRz()   const {if (  isRphi_) throw cms::Exception("L1track2D ERROR: You asked for r-z HT cell of r-phi track."); return cellLocation_;}
...
private:
  ...
  std::pair<unsigned int, unsigned int> cellLocation_; 
