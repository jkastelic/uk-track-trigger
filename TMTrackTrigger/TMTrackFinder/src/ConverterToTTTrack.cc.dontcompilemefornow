...
TTTrack< Ref_PixelDigi_ > ConverterToTTTrack::makeTTTrack(const L1track3D& trk, unsigned int iPhiSec, unsigned int iEtaReg) const {
  ...
  TTTrack< Ref_PixelDigi_ > track(ttstubrefs);
...
TTTrack< Ref_PixelDigi_ > ConverterToTTTrack::makeTTTrack(const L1fittedTrack& trk, unsigned int iPhiSec, unsigned int iEtaReg) const{
...
TTTrack< Ref_PixelDigi_ > ConverterToTTTrack::makeTTTrack(const L1fittedTrk4and5& trk4and5, unsigned int iPhiSec, unsigned int iEtaReg) const {
